...
function draw() {
   ...
   line(16, window_height - MarignBottom, window_weight-16, window_height - MarignBottom); // zero line
    ...
    text('Left probability', 16, window_height-16*4);
    ...
    text('z(' + b + ') = (a - μ) / σ = (' + b + ' - ' + mu + ') / ' + sigma + ' = ' + round((b-mu)/sigma,2), 16,window_height  - 16*6.5);
    ...
    text('P = ' + round(p2/100,4), 16, window_height - 32);
